const local = {
  en: {
    ...
    mainSkillsList: {
      ...
      js: 'JavaScript/Babbel React/Redux Typescript',
      design: 'Figma, AdobeXD, Photoshop',
      environment: 'Git/Github/Gitlab Webpack/Gulp Jira/Basecamp PhpStorm/Sublime'
    },
    supportSkillsTitle: 'Support skills',
    supportSkillsList: 'Php Next.js Jest',
